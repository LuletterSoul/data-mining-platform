 ...
 * @date created in 16:11 2017/7/10.
 * @description
 * @modified by:
 */
public class ByteStreamTranslator
{
    /**
     * 将一个2位字节数组转换为char字符。<br> 注意，函数中不会对字节数组长度进行判断，请自行保证传入参数的正确性。
     *
     * @param b
     *            字节数组
     * @return char字符
    ...
    /**
     * 将一个8位字节数组转换为双精度浮点数。<br> 注意，函数中不会对字节数组长度进行判断，请自行保证传入参数的正确性。
     *
     * @param b
     *            字节数组
     * @return 双精度浮点数
    ...
    /**
     * 将一个4位字节数组转换为浮点数。<br> 注意，函数中不会对字节数组长度进行判断，请自行保证传入参数的正确性。
     *
     * @param b
     *            字节数组
     * @return 浮点数
    ...
    /**
     * 将一个8位字节数组转换为长整数。<br> 注意，函数中不会对字节数组长度进行判断，请自行保证传入参数的正确性。
     *
     * @param b
     *            字节数组
     * @return 长整数
