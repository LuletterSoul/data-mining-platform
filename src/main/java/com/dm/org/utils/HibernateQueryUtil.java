...
public class HibernateQueryUtil
 {
    ...
    public static int setHqlQueryParameters(Query query, Map<String, Object> mapping,int orderFeedback)
    {
    ...
    public static boolean checkQueryPropertyJustifiability(Set columnNames, Class clazz) {
        try {
            String message = isExistPropertyMapping(clazz,
                    columnNames);
            if (!message.equals("")) {
                message += " column couldn't match appropriate mapping in "
    ...
    public static String buildOptionalSelectStatement(String[] columns, String from)
    {
        ...
        else
        {
            selectStatementBuilder.append("SELECT ").append(
                    buildStandardSelectClause(columns)).append(" ")
                    .append(from);
        }
    ...
    public static String buildUpdateStatement(Map<String, Object> updateMappingValues,
                                              Map<String, Object> conditionMappingValues,Class clazz)
            throws DataAccessObjectException
    {
        ...
        if (conditionMappingValues != null)
        {
            updateStatementBuilder
                    .append(buildUpdateClause(updateMappingValues, clazz.getSimpleName()))
                    .append(buildWhereClause(conditionMappingValues));
        }
        else
        {
...
//    }
    ...
    public static String isExistPropertyMapping(Class clazz, Set columnNames) {
        ...
        for (Object key : columnNames) {
            ...
            if (!resolvePropertyMapExistence(propertyNames, columnName,
...
//    }
    ...
    {
        currentPlaceholder = 0;
        StringBuilder updateHqlBuilder =
                new StringBuilder("UPDATE " + classSimpleName + " set ");
