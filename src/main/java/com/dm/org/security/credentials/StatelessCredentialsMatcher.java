...
public class StatelessCredentialsMatcher extends HashedCredentialsMatcher
{
     ...
     *
     * @see com.dm.org.security.realm.StatelessInfo
     * @see com.dm.org.security.realm.StatelessToken
     * @return 用于验证验证的成功与否.
     */
     ...
     * @see com.dm.org.security.realm.StatelessRealm#doGetAuthenticationInfo(AuthenticationToken)
     */
