...
public interface BaseService<E, PK extends Serializable>
{
     ...
     * @return 所有记录
     */
    List<Object[]> findAll(String[] columns)
        throws Exception;
     ...
     */
    @Deprecated
    List<E> findByProperties(Map<String, Object> constraintMap)
        throws Exception;
     ...
     */
    @Deprecated
    List<E> findByPropertyFuzzy(String propertyName, Object value)
        throws Exception;
     ...
     */
    @Deprecated
    List<E> findByPropertiesFuzzy(Map<String, Object> constraintMap)
        throws Exception;
     ...
     * @return 分页后的结果
     */
    // ResponsePage<E> pageByProperties(String columns,String[] propertyNames, Object[]
    // values,Pagination pagination)throws Exception;
     ...
     * @return
     */
    // ResponsePage<E> pageByProperty(String columns,String propertyName, Object value,Pagination
     ...
     * @return 分页后的结果
     */
    // ResponsePage<E> pageByPropertysFuzzy(String columns,String[] propertyNames, Object[]
    // values,Pagination pagination)throws Exception;
     ...
     * @return
     */
    // ResponsePage<E> pageByPropertyFuzzy(String columns,String propertyName, Object
    // value,Pagination pagination)throws Exception;

    // List<E> queryBySQL(SqlBean sql)throws Exception;

    List<Map<String, Object>> queryMapByHQL(String hql, Object[] args)
        throws Exception;

    // ResponsePage<E> pageBySQL(SqlBean sql,Pagination pagination)throws Exception;
    //
    // ResponsePage<Map<String, Object>> pageMapByHQL(String hql,Object[] args,Pagination
    // pagination)throws Exception;
     ...
     * @return
     */
    int countByPropertiesFuzzy(String propertyName, Object value)
        throws Exception;
