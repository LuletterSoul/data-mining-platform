...
--
-- Table structure for table `attr_feature_rela`
--

DROP TABLE IF EXISTS `attr_feature_rela`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `attr_feature_rela` (
...
--
-- Dumping data for table `attr_feature_rela`
--

LOCK TABLES `attr_feature_rela` WRITE;
/*!40000 ALTER TABLE `attr_feature_rela` DISABLE KEYS */;
/*!40000 ALTER TABLE `attr_feature_rela` ENABLE KEYS */;
UNLOCK TABLES;
