...
import com.vero.dm.repository.query.HibernateQueryUtil;
...
public class BaseDao<E, PK extends Serializable> implements BaseRepository<E, PK>
{
    ...
    public List<E> get(Pageable pageable)
    {
        ...
        return getSession().createQuery(criteriaQuery).setFirstResult(
            (pageable.getPageNumber() - 1) * pageable.getPageSize()).setMaxResults(
                pageable.getPageSize()).list();
    }
