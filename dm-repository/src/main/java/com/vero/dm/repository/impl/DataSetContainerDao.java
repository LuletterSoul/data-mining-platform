...
public class DataSetContainerDao extends BaseDao<DataSetContainer, String>
{
    ...
    public String linkPath(String containerId, String containerName, String fileName,
                           String filePath)
    {
        ...
        getSession().createQuery(hqlString).setParameter("containerId", containerId).setParameter(
            "containerName", containerName).setParameter("fileName", fileName).setParameter(
                "filePath", filePath).executeUpdate();
        return filePath;
    }
    ...
    public String getDataSetPath(String containerId)
    {
        ...
        return (String)getSession().createQuery(hqlString).setParameter("containerId",
            containerId).getSingleResult();
    }
    ...
    public List<DataSetContainer> fetchContainers(List<String> containerIds)
    {
        ...
        return getSession().createQuery(hqlString).setParameter("containerIds",
            containerIds).getResultList();
    }
