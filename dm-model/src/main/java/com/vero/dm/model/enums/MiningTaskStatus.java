...
public enum MiningTaskStatus implements BaseEnum {
    ...
    toBeAssigned(1, "TO_BE_ASSIGNED", "待分配"), attentionRequired(2, "ATTENTION_REQUIRED",
        "任务需推进"), completed(3, "COMPLETED", "任务完成"), inProgress(4, "IN_PROGRESS",
            "任务进行中"), incomplete(5, "IN_COMPLETE", "任务未完成"), newTask(6, "NEW_TASK", "新任务");
