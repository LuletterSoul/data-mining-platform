...
public class ZipUtil {
    ...
    private static void zipFile(String srcRootDir, File file, ZipOutputStream zos) throws IOException {
     ...
     * @param zipPath     压缩文件保存的路径。注意：zipPath不能是srcPath路径下的子文件夹
     * @param zipFileName 压缩文件名
     * @param specialPaths 指定的文件
     * @throws Exception
     */
    public static void zip(String srcPath, String zipPath, String zipFileName, List<String> specialPaths) throws Exception {
        if (StringUtils.isEmpty(srcPath) || StringUtils.isEmpty(zipPath) || StringUtils.isEmpty(zipFileName)) {
            throw new ParameterException("1");
        }
    ...
    public static void unzip(String zipFilePath, String unzipFilePath, boolean includeZipFileName) throws Exception
    {
        ...
        {
            throw new ParameterException("11");
        }
        File zipFile = new File(zipFilePath);
    ...
    {
//        String zipPath = "F:\\GitHup\\data-minning-platform\\dm-web\\target\\classes\\data_sets";
//        String dir = "F:\\GitHup\\data-minning-platform\\dm-web\\target\\classes\\data_sets\\2c948a84619f883a01619f90a0320009";
...
//        }
        ...
        String dir = "F:\\GitHup\\data-minning-platform\\dm-web\\target\\classes\\data_sets\\2c948a84619f883a01619f90a0320009";
        String zipFileName = "test.zip";
        List<String> specialFilePaths = new LinkedList<>();
        specialFilePaths.add("F:\\GitHup\\data-minning-platform\\dm-web\\target\\classes\\data_sets\\2c948a84619f883a01619f90a0320009\\1.txt");
        specialFilePaths.add("F:\\GitHup\\data-minning-platform\\dm-web\\target\\classes\\data_sets\\2c948a84619f883a01619f90a0320009\\2.txt");
        try
        {
            zip(dir, zipPath, zipFileName,specialFilePaths);
        }
        catch (Exception e)
        {
            e.printStackTrace();
