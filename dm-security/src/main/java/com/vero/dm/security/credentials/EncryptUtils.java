 ...
 * @version 1.5 created in 1:34 2017/7/26.
...
public class EncryptUtils
{
    ...
    private static UserPasswordService passwordService = new UserPasswordServiceImpl();
    ...
    public static void main(String[] args)
        throws Exception
    {
        KEY = passwordService.generateRandomSalt(8).toHex();
        String content = "我爱你";
